...
#===================================Main Screen==================================
txt_input = StringVar(value = 'Malhar Hotels...')
Display = Entry(Tops, font=('arial',98,'bold'),fg='white',bd=10,bg='blue',justify='center',textvariable=txt_input)
...
btn7 = Button(f2,padx=15,pady=3,bd=6,font=('arial',30,'bold'),text='7',command=lambda:btn(7)).grid(row=2,column=0)
btn8 = Button(f2,padx=15,pady=3,bd=6,font=('arial',30,'bold'),text='8',command=lambda:btn(8)).grid(row=2,column=1)
btn9 = Button(f2,padx=15,pady=3,bd=6,font=('arial',30,'bold'),text='9',command=lambda:btn(9)).grid(row=2,column=2)
btnC = Button(f2,padx=15,pady=3,bd=6,font=('arial',30,'bold'),text='C',bg='green', command=Clear).grid(row=2,column=3)

#==================================Row 2========================================

btn4 = Button(f2,padx=15,pady=3,bd=6,font=('arial',30,'bold'),text='4',command=lambda:btn(4)).grid(row=3,column=0)
btn5 = Button(f2,padx=15,pady=3,bd=6,font=('arial',30,'bold'),text='5',command=lambda:btn(5)).grid(row=3,column=1)
btn6 = Button(f2,padx=15,pady=3,bd=6,font=('arial',30,'bold'),text='6',command=lambda:btn(6)).grid(row=3,column=2)
btnplus = Button(f2,padx=18,pady=3,bd=6,font=('arial',30,'bold'),text='+',bg='orange',command=lambda:btn('+')
                 ).grid(row=3,column=3)

#==================================Row 3========================================

btn1 = Button(f2,padx=15,pady=3,bd=6,font=('arial',30,'bold'),text='1',command=lambda:btn(1)).grid(row=4,column=0)
btn2 = Button(f2,padx=15,pady=3,bd=6,font=('arial',30,'bold'),text='2',command=lambda:btn(2)).grid(row=4,column=1)
btn3 = Button(f2,padx=15,pady=3,bd=6,font=('arial',30,'bold'),text='3',command=lambda:btn(3)).grid(row=4,column=2)
btnminus = Button(f2,padx=23,pady=3,bd=6,font=('arial',30,'bold'),text='-',bg='orange',command=lambda:btn('-')
                  ).grid(row=4,column=3)

#==================================Row 4========================================

btn0 = Button(f2,padx=15,pady=3,bd=6,font=('arial',30,'bold'),text='0',command=lambda:btn(0)).grid(row=5,column=0)
btndot = Button(f2,padx=21,pady=3,bd=6,font=('arial',30,'bold'),text='.',bg='orange',command=lambda:btn('.')
                ).grid(row=5,column=1)
btndivision = Button(f2,padx=20,pady=3,bd=6,font=('arial',30,'bold'),text='/',bg='orange',command=lambda:btn('/')
                     ).grid(row=5,column=2)
btnmultiply = Button(f2,padx=19,pady=3,bd=6,font=('arial',30,'bold'),text='x',bg='orange',command=lambda:btn('*')
                     ).grid(row=5,column=3)

#==================================Row 5========================================

btnequals = Button(f2,padx=64,pady=2,bd=6,font=('arial',30,'bold'),text='=',bg='green',command=Equal
                   ).grid(row=6,column=0,columnspan=2)
btnopenbracket = Button(f2,padx=19,pady=2,bd=6,font=('arial',30,'bold'),text='(',bg='orange',command=lambda:btn('(')
                        ).grid(row=6,column=2)
btnclosebracket = Button(f2,padx=23,pady=2,bd=6,font=('arial',30,'bold'),text=')',bg='orange',command=lambda:btn(')')
                         ).grid(row=6,column=3)
...
lblMeal = Label(f1,font=('arial',15,'bold'),text='Choose Meal',bd=10,anchor=W)
...
#=======================================Control Buttons=========================================
btnConvert = Button(f1,padx=10,pady=4,bd=10,fg='white',font=('arial',16,'bold'),width=10,text='Convert',bg='orange',
                    command=Convert)
btnConvert.grid(row=8,column=2)

btnTotal = Button(f4,padx=10,pady=8,bd=10,fg='white',font=('arial',16,'bold'),width=10,text='Total',bg='orange',
                  command=TotalResult)
btnTotal.grid(row=0,column=0)

btnScreen = Button(f4,padx=10,pady=8,bd=10,fg='white',font=('arial',16,'bold'),width=10,text='Clear',bg='blue',
                   command=ClearScreen)
btnScreen.grid(row=1,column=0)

btnReset = Button(f4,padx=10,pady=8,bd=10,fg='white',font=('arial',16,'bold'),width=10,text='Reset',bg='green',
                  command=Reset)
btnReset.grid(row=2,column=0)

btnExit = Button(f4,padx=10,pady=8,bd=10,fg='white',font=('arial',16,'bold'),width=10,text='Exit',bg='red',
                 command=Exit)
btnExit.grid(row=3,column=0)

#========================================Logo=======================================================
photo = PhotoImage(file='gp.png')
